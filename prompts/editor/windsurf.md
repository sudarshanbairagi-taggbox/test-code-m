# Windsurf - build a Taggbox social widget
...
curl -sSLo .windsurf/rules/taggbox.md "$BASE/prompts/TAGGBOX_CONTEXT.md"
```
...
curl.exe -sSLo .windsurf/rules/taggbox.md "$BASE/prompts/TAGGBOX_CONTEXT.md"
```
