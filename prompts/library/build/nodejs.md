...
Step 4 writes no code any more: the Node.js code is finished, tested and
zipped with all 19 themes, the sample posts and a README:
BASE/templates/dist/social-widget-nodejs.zip
(source: BASE/templates/nodejs/ - built by tools/build-previews.py).
...
go into the starter's own files - server.js - keeping its markup, the
