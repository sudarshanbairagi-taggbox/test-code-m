# Prompt 3d, part 1 of 2 - auto-refresh in index.php
...
BASE/prompts/library/auto-refresh/change.md
Already fetched it for an earlier part? Do not fetch it again.

Add the meta tag to the page head in index.php. Give back the
complete file.
